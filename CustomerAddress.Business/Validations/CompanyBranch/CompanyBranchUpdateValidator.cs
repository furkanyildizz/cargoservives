...
{
    public class CompanyBranchUpdateValidator: AbstractValidator<CompanyBranchUpdateDto>
    {
        private ICompanyBranchService _companyBranchService;
        public CompanyBranchUpdateValidator(ICompanyBranchService companyBranchService)
        {
