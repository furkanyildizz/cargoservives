...
namespace CustomerAddress.Business.Validations.Address
{
    public class AddressAddValidator : AbstractValidator<AddressAddDto>
    {
        ...
        public AddressAddValidator(IAddressService addressService, IStreetService streetService, INeighborhoodService neighborhoodService, ICityService cityService, ITownService townService)
        {
