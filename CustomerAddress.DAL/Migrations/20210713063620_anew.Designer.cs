...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomerAddress.DAL.Entities.RouteMap", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CustomerAddress.DAL.Entities.Status", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CustomerAddress.DAL.Entities.RouteMap", b =>
                {
                    ...
                    b.HasOne("CustomerAddress.DAL.Entities.Post", "PostFK")
                        .WithMany("RouteMaps")
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CustomerAddress.DAL.Entities.Status", "StatusFK")
                        .WithMany("RouteMaps")
